...
namespace RadCms.Core.Tests.Abstract
{
    public abstract class WebpartDriverTests
    {
        public abstract IWebpartDriver CreateInstance();
        ...
        public void BuildDisplayTest()
        {
            ...
            Assert.AreEqual(driverResult.Content.Contains("data-replace=\"[$webpart(" + _driver.WebpartId.ToLower() + ")$]\""), true);
        }
