...
namespace RadCms.Test
{
    ...
    public class UtilityTest
    {
        ...
        {
            var assemblies = GetAllAssemblies(Path.Combine(Environment.CurrentDirectory, "../../RadCms/bin"));
        ...
        private List<Assembly> GetAllAssemblies(string path)
        {
            ...
            return files.Where(e => !e.Name.StartsWith("Kendo")).ToList().ConvertAll(file => Assembly.LoadFile(file.FullName));
        }
