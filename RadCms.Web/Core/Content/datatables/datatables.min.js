...
{} : f.val, b[f.name].__dt_wrapper = !0, u.extend(a, b[f.name], f.propExt)
  ...
  }; m.ext = x = { buttons: {}, classes: {}, build: "dt/jqc-1.12.4/dt-1.10.13", errMode: "alert", feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: m.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: m.version }; h.extend(x, {
