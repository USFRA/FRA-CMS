...
namespace RadCms.Services
{
    ...
    {
        public RequestContext context { private get; set; }
        private string GeneratePageButtons(UrlHelper url, bool isPublished, int status, int sectionId, string modifiedBy, DateTime lastModified, int accessMode)
        {
        ...
        public MvcHtmlString GeneratePageSubButtons(int status, int sectionId, int accessMode = 0)
        {
        ...
        public MvcHtmlString PageButtons(bool isPublished, int status,
            int sectionId, int accessMode)
        {
            return MvcHtmlString.Create(GeneratePageButtons(new UrlHelper(context),
                isPublished, status, sectionId, null, DateTime.Now, accessMode
                ));
        }


        public MvcHtmlString PageButtons(bool isPublished, int status, int sectionId,
